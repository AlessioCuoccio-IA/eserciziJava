...
public class MenuAL {
	...
	static AnagraficaDAOimplAL implAL = new AnagraficaDAOimplAL();
	...
	private static void listaAnagrafiche() throws IOException {
		for (Anagrafica a : implAL.getAnagrafica()) {
	...
	private static void inserisciAnagrafica() throws IOException {
		...
		implAL.insertAnagrafica(new Anagrafica(nome, cognome, citta, dataNascita));
		JOptionPane.showMessageDialog(null, "Cosa vuoi fare adesso?");

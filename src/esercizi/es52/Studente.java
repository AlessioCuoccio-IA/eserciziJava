...
public class Studente {
	...
	public Studente(String nome, String cognome, String citta, String dataNascita) {
	...
	public Studente(String nome, String cognome, String citta, LocalDate dataNascita) {
		this.id = GestoreAnagrafica.contatore++;
		this.nome = nome;
		this.cognome = cognome;
		this.citta = citta;
